...
public class BookActivity2 extends AppCompatActivity {
  ...
  //  private SeekBar progressBar;
    private NumberPicker progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // progressBar = (SeekBar)findViewById(R.id.seekBar);
        progressBar = (NumberPicker) findViewById(R.id.numberPicker);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (book != null) {
                  ...
                  //  progressBar.setMax(Integer.parseInt(book.getBookPages()));
                    progressBar.setMaxValue(Integer.parseInt(book.getBookPages()));
                   // progressBar.setProgress(Integer.parseInt(book.getBookProgress()));
                    progressBar.setValue(Integer.parseInt(book.getBookProgress()));
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(BookActivity2.this,"Updated",Toast.LENGTH_LONG).show();
                finish();
            }
        });
    ...
    public void updateProgressBar(){
       /* progressBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
        ...
        progressBar.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            @Override
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                pageNumbersTextView.setText("Page " + newVal + " of " + book.getBookPages());
                tempProgress = newVal;
            }
        });
    ...
    public void deleteBook() {
        AlertDialog.Builder adb = new AlertDialog.Builder(BookActivity2.this);
